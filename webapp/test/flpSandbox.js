		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsmaestrodetalle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsmaestrodetalle-display": {
								"semanticObject": "nsmaestrodetalle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.maestrodetalle",
									"url": sap.ui.require.toUrl("ns/maestrodetalle")
								}
							}
						}
					}
